...
export default function AuroraLanding() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 text-white flex items-center justify-center">
      <motion.div
        className="absolute inset-0"
        style={{
          background:
            'radial-gradient(circle at 20% 20%, rgba(255,255,255,0.05), transparent 60%), radial-gradient(circle at 80% 80%, rgba(255,255,255,0.03), transparent 70%)',
        }}
        animate={{
      ...
      {[...Array(3)].map((_, i) => (
        <motion.div
          key={i}
          className="absolute w-64 h-64 rounded-full bg-gradient-to-br from-purple-500/20 to-blue-500/20 blur-3xl"
          style={{
            top: `${20 + i * 20}%`,
            left: `${15 + i * 30}%`,
          }}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-300 via-pink-300 to-blue-300 animate-[gradient-shift_6s_infinite]">
            Meet. Plan. Flow.
          </h1>

          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            Turn chaos into clarity. MeetFlow intelligently schedules, adapts,
            and connects your team — so you can focus on what truly matters.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              asChild
              size="lg"
              className="px-8 py-6 rounded-xl bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-400 hover:to-blue-400 shadow-lg shadow-purple-500/20"
            >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-t from-purple-900/40 to-transparent rounded-3xl blur-xl"></div>
          <Image
            src="/planning.svg"
